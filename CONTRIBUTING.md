...
Thank you for considering contributing to `atcddd`! We welcome contributions
from the R and health data science community.

## How to Contribute

### 1. Report Bugs

Open an issue on [GitHub Issues](https://github.com/vanhungtran/atcddd/issues):

- Use a clear, descriptive title
- Include a minimal reproducible example
- Describe expected vs. actual behavior
- Note your R version, operating system, and package version (`packageVersion("atcddd")`)
...
5. Run `devtools::document()` to regenerate documentation
...
- Regenerate docs with `devtools::document()`
