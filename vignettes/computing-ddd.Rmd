...
Download the WHO ATC/DDD Index to your local cache (one-time setup), then
load it into memory. Subsequent sessions load from cache without internet:
...
cat(sprintf("Cached data: %d ATC codes, %d DDD entries",
            nrow(atc_codes), nrow(atc_ddd)))
```

> Once downloaded, data persist in your local cache. All subsequent analysis
> works offline.
...
working entirely offline against the cached database.
