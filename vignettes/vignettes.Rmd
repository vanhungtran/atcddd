...
To create or update the package logo, run the following commands in your R console:

```{r logo_creation, eval=FALSE}
# 1. Install required packages
install.packages(c("hexSticker", "ggplot2", "dplyr", "showtext"))

# 2. Generate all 5 logo options
source("create_logo.R")

# 3. Preview and choose favorite
# Files created: logo_option1.png through logo_option5.png

# 4. Activate chosen logo
